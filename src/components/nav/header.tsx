...
export function Header({ children }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 p-2 w-full border-b border-black/20 dark:border-white/20 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
